...
# Password hashing - Use most secure algorithms
# NOTE: Passwords are NEVER stored in plain text
# Django automatically hashes all passwords using PBKDF2 with 260,000+ iterations
PASSWORD_HASHERS = [
...
TARGET_SOLUTIONS_API_KEY = env('TARGET_SOLUTIONS_API_KEY', default='')
TARGET_SOLUTIONS_BASE_URL = env('TARGET_SOLUTIONS_BASE_URL', default='')
NOCODB_API_TOKEN = env('NOCODB_API_TOKEN', default='')
NOCODB_BASE_URL = env('NOCODB_BASE_URL', default='')
